...
lb13 = linebuffer1D 1 3 300 1 0 T_Int 

lb23 = linebuffer1D 2 3 300 1 0 T_Int 

lb13Underutil = underutil 2 $ linebuffer1D 2 3 300 1 0 T_Int

lbChain = 
  Constant_Int [1] |>>=|
  linebuffer1D 1 3 300 1 0 T_Int |>>=|
  linebuffer1D 1 3 300 1 0 (T_Array 3 T_Int)
...
lbChainReadyValid =
  ...
  readyValid (linebuffer1D 1 3 300 1 0 (T_Array 3 T_Int))
